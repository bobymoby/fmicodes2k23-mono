    ...
    return (
        <div>
            ...
            <div>
                ...
                <p>
                    {' '}
                    after {roundTimer} minutes have passed, The voting phase
                    starts ,
                </p>
                <p>
                    all players assemble and try to guess who is the bug within
                    their code.
                </p>
                <p>
                    if there are more than a certain ammount of tasks that do
                    not work
                </p>
                <p>
                    the debuggers lose a live. If the debuggers lose{' '}
                    {debuggerLives} the game is over and the bugs win
                </p>
